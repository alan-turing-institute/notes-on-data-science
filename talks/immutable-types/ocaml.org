...
We're going to build this type out of pairs.  It will be roughly like
this:
...
That's three ints: 10, 20, and 30.  We are trying to say "this is a
pair.  The first element of the pair is the first element of the list.
The second element of the pair is the rest of the list."  The special
value Nil means "an empty list."

Here's the definition. The name Cons, short for "construct" is
traditional. 
